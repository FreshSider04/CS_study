...
-- com[0]	=>  Location: PIN_66,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- com[1]	=>  Location: PIN_136,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- com[2]	=>  Location: PIN_120,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- com[3]	=>  Location: PIN_121,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_out[0]	=>  Location: PIN_103,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_out[1]	=>  Location: PIN_105,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- data_out[4]	=>  Location: PIN_112,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_out[5]	=>  Location: PIN_119,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_out[6]	=>  Location: PIN_115,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- b[0]	=>  Location: PIN_111,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \M1|z~0_combout\ = (\b[3]~input_o\ & (\b[0]~input_o\ & (\b[2]~input_o\ $ (\b[1]~input_o\)))) # (!\b[3]~input_o\ & (!\b[1]~input_o\ & (\b[0]~input_o\ $ (\b[2]~input_o\))))
...
-- Equation(s):
-- \M2|z~0_combout\ = (\b[3]~input_o\ & ((\b[0]~input_o\ & ((!\b[1]~input_o\))) # (!\b[0]~input_o\ & (!\b[2]~input_o\)))) # (!\b[3]~input_o\ & ((\b[0]~input_o\ $ (!\b[1]~input_o\)) # (!\b[2]~input_o\)))
...
-- Equation(s):
-- \M3|z~0_combout\ = (\b[3]~input_o\ & (((\b[0]~input_o\ & !\b[1]~input_o\)) # (!\b[2]~input_o\))) # (!\b[3]~input_o\ & ((\b[0]~input_o\) # ((\b[2]~input_o\) # (!\b[1]~input_o\))))
...
PORT MAP (
	datab => \C1|U4|count\(2),
	datac => \M3|z~0_combout\,
	datad => \M3|z~1_combout\,
...
-- Equation(s):
-- \M4|z~0_combout\ = (\b[1]~input_o\ & ((\b[0]~input_o\ & ((\b[2]~input_o\))) # (!\b[0]~input_o\ & (\b[3]~input_o\ & !\b[2]~input_o\)))) # (!\b[1]~input_o\ & (!\b[3]~input_o\ & (\b[0]~input_o\ $ (\b[2]~input_o\))))
...
PORT MAP (
	datab => \C1|U4|count\(2),
	datac => \M5|z~1_combout\,
	datad => \M5|z~0_combout\,
	combout => \M5|z~2_combout\);

-- Location: LCCOMB_X29_Y20_N20
\M6|z~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \M6|z~0_combout\ = (\b[1]~input_o\ & (((\b[3]~input_o\) # (\b[2]~input_o\)))) # (!\b[1]~input_o\ & ((\b[3]~input_o\ $ (\b[2]~input_o\)) # (!\b[0]~input_o\)))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1111110001111101",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \b[0]~input_o\,
...
-- pragma translate_on
PORT MAP (
	datab => \M6|z~0_combout\,
	datac => \M6|z~1_combout\,
	datad => \C1|U4|count\(2),
...
-- Equation(s):
-- \M7|z~1_combout\ = (\b[0]~input_o\ & ((\b[3]~input_o\) # (\b[2]~input_o\ $ (\b[1]~input_o\)))) # (!\b[0]~input_o\ & ((\b[1]~input_o\) # (\b[3]~input_o\ $ (\b[2]~input_o\))))
...
-- Equation(s):
-- \M7|z~0_combout\ = (\a[0]~input_o\ & ((\a[3]~input_o\) # (\a[2]~input_o\ $ (\a[1]~input_o\)))) # (!\a[0]~input_o\ & ((\a[1]~input_o\) # (\a[2]~input_o\ $ (\a[3]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \M7|z~1_combout\,
	datab => \C1|U4|count\(2),
	datac => \M7|z~0_combout\,

...
-- g	=>  Location: PIN_132,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- com[0]	=>  Location: PIN_39,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- com[1]	=>  Location: PIN_60,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- com[2]	=>  Location: PIN_138,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- com[3]	=>  Location: PIN_125,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A[1]	=>  Location: PIN_141,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \a~0_combout\ = (\A[3]~input_o\) # ((\A[1]~input_o\) # (\A[2]~input_o\ $ (!\A[0]~input_o\)))
...
-- Equation(s):
-- \b~0_combout\ = (\A[1]~input_o\ $ (!\A[0]~input_o\)) # (!\A[2]~input_o\)
...
-- Equation(s):
-- \c~0_combout\ = (\A[2]~input_o\) # ((\A[0]~input_o\) # (!\A[1]~input_o\))
...
-- Equation(s):
-- \d~0_combout\ = (\A[3]~input_o\) # ((\A[2]~input_o\ & (\A[1]~input_o\ $ (\A[0]~input_o\))) # (!\A[2]~input_o\ & ((\A[1]~input_o\) # (!\A[0]~input_o\))))
...
-- Equation(s):
-- \d~1_combout\ = (!\A[0]~input_o\ & ((\A[1]~input_o\) # (!\A[2]~input_o\)))
...
-- Equation(s):
-- \f~0_combout\ = (\A[3]~input_o\) # ((\A[2]~input_o\ & ((!\A[0]~input_o\) # (!\A[1]~input_o\))) # (!\A[2]~input_o\ & (!\A[1]~input_o\ & !\A[0]~input_o\)))
...
-- Equation(s):
-- \g~0_combout\ = (\A[3]~input_o\) # ((\A[2]~input_o\ & ((!\A[0]~input_o\) # (!\A[1]~input_o\))) # (!\A[2]~input_o\ & (\A[1]~input_o\)))
